...
import views.html._
/**/
object description extends BaseScalaTemplate[play.api.templates.Html,Format[play.api.templates.Html]](play.api.templates.HtmlFormat) with play.api.templates.Template4[Course,List[CourseDescription],String,User,play.api.templates.Html] {

    /**/
    def apply/*1.2*/(course:Course,courseDescriptions:List[CourseDescription],enrollment:String,user:User):play.api.templates.Html = {
...
""")))})),format.raw/*20.2*/("""
	...
	""")))})),format.raw/*35.3*/("""
""")))})),format.raw/*36.2*/("""
 """),_display_(Seq[Any](/*37.3*/courseDescriptions/*37.21*/.map/*37.25*/ { task =>_display_(Seq[Any](format.raw/*37.35*/("""
...
"""))}
    ...
    def render(course:Course,courseDescriptions:List[CourseDescription],enrollment:String,user:User): play.api.templates.Html = apply(course,courseDescriptions,enrollment,user)
    
    def f:((Course,List[CourseDescription],String,User) => play.api.templates.Html) = (course,courseDescriptions,enrollment,user) => apply(course,courseDescriptions,enrollment,user)
    ...
    def ref: this.type = this
                ...
                /*
                    ...
                    SOURCE: D:/sdu-online-courses/app/views/course/description.scala.html
                    HASH: dcb1c95d5256404961a49f60d622f8eea9455597
